...
This is the first post in a series looking at g-methods and their doubly robust extensions for estimating causal effects in epidemiological research. This one is focused on time fixed treatments (or exposures) and the second will cover the case of time varying treatments. My main goal with writing this was to improve my own understanding and I'm hopeful that it might be useful to anyone else getting familiar with the field.

Big thank you to Noah Greifer for some very helpful notes on a previous version. 
